<p align="center">
  <img src="./docs/assets/readme/wabachi-hero.svg" alt="WABACHI — Repository Semantic Authority. Evidence → Derived State → Review / Admission → Canonical Declaration. Explicit · Auditable · Canonical." width="100%">
</p>
